...
data, temps = getTempData(num_data_points=num_pts,L=L)
...
if L == 8:
    data = data.reshape(len(data)/102400,102400)
    data = np.asarray([item.reshape(8,8,8,200).swapaxes(1,2).swapaxes(1,2) for item in data])
